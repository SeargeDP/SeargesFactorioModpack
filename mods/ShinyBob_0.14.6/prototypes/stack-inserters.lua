...
if extra_stack_inserters then
	data:extend(
	{

	  {
	    type = "item",
	    name = "stack-inserter",
	    icon = "__ShinyBob__/graphics/entity/inserter/icon/stack/stack-inserter.png",
	  ...
	  },
	  {
	    ...
	    hand_base_picture =
	    {
	      filename = "__ShinyBob__/graphics/entity/inserter/stack-inserter-hand-base.png",
	      priority = "extra-high",
	      width = 8,
	      height = 34
	    },
	    hand_closed_picture =
	    {
	      filename = "__ShinyBob__/graphics/entity/inserter/stack-inserter-hand-closed.png",
	      priority = "extra-high",
	      width = 24,
	      height = 41
	    },
	    hand_open_picture =
	    {
	      filename = "__ShinyBob__/graphics/entity/inserter/stack-inserter-hand-open.png",
	      priority = "extra-high",
	      width = 32,
	      height = 41
	    },
	    ...
	    platform_picture =
	    {
	      sheet=
	      {
		filename = "__ShinyBob__/graphics/entity/inserter/stack-inserter-platform.png",
		priority = "extra-high",
		width = 46,
		height = 46,
		shift = {0.09375, 0}
...
if extra_stack_inserters and bobmods.config.logistics.LongInserters then
	data:extend(
	{
...

	    {
	      ...
	      icon = "__ShinyBob__/graphics/entity/inserter/icon/stack/stack-long-inserter.png",
	      flags = {"goes-to-quickbar"},
	      subgroup = "addon-stack-inserter",
...
if extra_stack_inserters  and bobmods.config.logistics.LongInserters and bobmods.config.logistics.NearInserters then
	data:extend(
	{

	    {
	      ...
	      icon = "__ShinyBob__/graphics/entity/inserter/icon/stack/stack-far-inserter.png",
	      flags = {"goes-to-quickbar"},
	      subgroup = "addon-stack-inserter",
	    ...
	    },
	  {
	    ...
	    icon = "__ShinyBob__/graphics/entity/inserter/icon/stack/stack-near-inserter.png",
	    flags = {"goes-to-quickbar"},
	    subgroup = "addon-stack-inserter",
...
if extra_stack_inserters then
	data:extend(
	{
	  ...
	  {
	    type = "technology",
	    name = "stack-long-near-inserters-1",
	    icon = "__ShinyBob__/graphics/entity/inserter/icon/stack/stack-inserter.png",
	    effects =     {
	    },
	    prerequisites =
