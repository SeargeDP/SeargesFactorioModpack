...
aadd("z-chemistry-5",		"addon-sulfur-dioxide",							"a")
aadd("z-chemistry-5",		"addon-sulfur-dioxide-nickel",					"b")
aadd("z-chemistry-5",		"addon-sulfur-acid-nickel",						"c")
aadd("z-chemistry-5",		"addon-sulfur-acid-nickel-2",					"d")

aadd("z-chemistry-6",		"addon-calcium-chloride",						"a")
aadd("z-chemistry-6",		"addon-sodium-hydroxide-compact",				"b")
aadd("z-chemistry-6",		"addon-salt-water-electrolysis",				"c")
aadd("z-chemistry-6",		"addon-lithium-water-electrolysis",				"d")
...
aadd("z-gathering-1",		"wooden-crate",									"b")
aadd("z-gathering-1",		"iron-chest",									"c")
aadd("z-gathering-1",		"steel-chest",									"d")
aadd("z-gathering-1",		"titanium-chest",								"e")
aadd("z-gathering-1",		"titanium-chest",								"f")
aadd("z-gathering-1",		"tungsten-chest",								"g")
aadd("z-gathering-1",		"basic-repository",								"h")
...
aadd("z-logistic-4",		"logistic-chest-titanium-storage",				"i")
aadd("z-logistic-4",		"logistic-chest-tungsten-storage",				"j")
...
aadd("z-transport-5",		"2xUndergroundPipe",							"d")
aadd("z-transport-5",		"4xUndergroundPipe",							"e")
aadd("z-transport-5",		"10xUndergroundPipe",							"f")
aadd("z-transport-5",		"25xUndergroundPipe",							"g")
